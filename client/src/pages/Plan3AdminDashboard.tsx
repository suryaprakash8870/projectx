...
export default function Plan3AdminDashboard() {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div>
        <h1 className="page-heading">Plan 3 — Investment Program</h1>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <KPICard label="Total Members"    value={isLoading ? '—' : (stats?.totalMembers    || 0)} icon={<UsersIcon size={18} />}         color="#0066ff" sub="All Plan 3 users" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Link to="/admin?tab=members"
          ...
          <div>
            ...
            <div className="text-xs t-text-3 mt-1">View and search Plan 3 members</div>
          </div>
          <ArrowRightIcon size={20} />
        </Link>
      </div>
      ...
      <div className="card border-l-4 border-l-brand-500">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm t-text-3">
            <div className="font-bold t-text mb-1">About Plan 3</div>
            <p>
              The Investment Program is completely separate from Plan 1 and Plan 2. Members join via a referral
